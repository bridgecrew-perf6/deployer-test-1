...
class Pagination {
	 ...
	 * @param  string  $args
	 *
	 * @uses Pagination::get_pagination_arr()
	 *
	 */
	static function render( $args = '' ) {
		...
		get_template_part('/views/components/pagination', '', $pagination_items);
	}
	 ...
	 * control of display. The 'list' value will place all the paginated links in
	 ...
	 *
	 * If the 'show_all' argument is set to true, then it will show all the pages
