...
if ( ! class_exists( 'TgmPluginActivation' ) ) {
	...
	class TgmPluginActivation {
		 ...
		 * @since 2.0.0
		 *
		 * @see TgmPluginActivation::admin_menu()
		 * @see TgmPluginActivation::notices()
		 * @see TgmPluginActivation::styles()
		 */
		 ...
		 *
		 * @see TgmPluginActivation::init()
		 * @see TgmPluginActivation::install_plugins_page()
		 *
		 ...
		 * @since 2.4.0
		 *
		 * @return \TgmPluginActivation The TgmPluginActivation object.
		 */
	...
	if ( ! function_exists( 'load_tgm_plugin_activation' ) ) {
		...
		function load_tgm_plugin_activation() {
			$GLOBALS['tgmpa'] = TgmPluginActivation::get_instance();
		}
	}
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		 ...
		 *
		 * @since      2.2.0
		 * @deprecated 2.5.0 use {@see TgmPluginActivation::_get_plugin_data_from_name()} instead.
		 * @see        TgmPluginActivation::_get_plugin_data_from_name()
		 *
		 * @param string $name Name of the plugin, as it was registered.
		 * @param string $data Optional. Array key of plugin data to return. Default is slug.
		 * @return string|boolean Plugin slug if found, false otherwise.
		...
		protected function _get_plugin_data_from_name( $name, $data = 'slug' ) {
			_deprecated_function( __FUNCTION__, 'TGMPA 2.5.0', 'TgmPluginActivation::_get_plugin_data_from_name()' );
