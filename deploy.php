...
// hosts
inventory('hosts.yml'); // !!!PLEASE EDIT!!!

// use localhost host to configure some local paths
localhost()
    ->stage('dev')
    ->set('public_url', 'https://acrm.loc') // !!!PLEASE EDIT!!!
...
set('theme/name', 'acrm'); // !!!PLEASE EDIT!!!
//set('mu-plugin/name', 'core-functionality'); // !!!PLEASE EDIT!!!

// TASKS

// Overwrite deployment with rsync (instead of git)
task('deploy:update_code', ['wp:push', 'themes:push', 'plugins:push']); // does not include uploads & database (see below)
